...
## How to Run
1. Open in Colab:  
   [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Taimoor-Anjum/Rain-Prediction-Weather-ML/blob/main/Weather_Forecasting_Project_(2).ipynb)
